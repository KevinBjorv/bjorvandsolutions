# Unity Serialization Migration Guard — Full Documentation
...
## Access Paths
- Unity menu: `Tools/Unity Serialization Migration Guard/Open Window` opens the RMSS window.
- Unity menu: `Tools/Unity Serialization Migration Guard/Open Project Settings` opens Project Settings at `Project/Unity Serialization Migration Guard`.
...
- Path: `Project/Unity Serialization Migration Guard`
